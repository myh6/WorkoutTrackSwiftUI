...
extension WorkoutDataStoreTests {
    ...
    func expect(_ sut: WorkoutSessionStore, toRetrieveEntry expected: [WorkoutEntry], withQuery query: SessionQueryDescriptor? = nil, file: StaticString = #file, line: UInt = #line) async throws {
        
        let retrieved = try await sut.retrieve(query: query).flatMap(\.entries)
        XCTAssertEqual(expected, retrieved, file: file, line: line)
    }
    
    func expect(_ sut: WorkoutSessionStore, toRetrieveEntryTwice expected: [WorkoutEntry], withQuery query: SessionQueryDescriptor? = nil, file: StaticString = #file, line: UInt = #line) async throws {
    ...
    func expect(_ sut: WorkoutSessionStore, toRetrieve expectedSessions: [WorkoutSession], withQuery query: SessionQueryDescriptor? = nil, file: StaticString = #file, line: UInt = #line) async throws {
        let retrieve = try await sut.retrieve(query: query)
        XCTAssertEqual(retrieve, expectedSessions, file: file, line: line)
    }
    
    func expect(_ sut: WorkoutSessionStore, toRetrieveTwice expectedSessions: [WorkoutSession], withQuery query: SessionQueryDescriptor? = nil, file: StaticString = #file, line: UInt = #line) async throws {
        try await expect(sut, toRetrieve: expectedSessions, withQuery: query, file: file, line: line)
        try await expect(sut, toRetrieve: expectedSessions, withQuery: query, file: file, line: line)
    }
    
    func expect(_ sut: WorkoutSessionStore, toRetrieveSets expectedSets: [WorkoutSet], withQuery query: SessionQueryDescriptor? = nil, file: StaticString = #file, line: UInt = #line) async throws {
